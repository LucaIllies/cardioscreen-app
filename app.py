...
def load_or_train_model():
    ...
    for path in ["heart_disease.csv", "data/heart_disease.csv"]:
...
<div class="header-box">
  <h1>🫀 CardioScreen</h1>
  <p>AI-powered cardiac pre-screening for GP intake · Classical ML · 630,000 patients trained · ROC-AUC 0.956 · 90.2% Recall</p>
</div>
""", unsafe_allow_html=True)
...
st.markdown("")
st.caption("CardioScreen · HistGradientBoosting · Trained on 630,000 patients · Nova SBE — AI Impact on Business · Group Assignment")
